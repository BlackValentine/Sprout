      ...
      <>
        ...
        <div className="px-40 pt-16 mx-10 bg-timberwolf text-gray2">
          ...
          <p className="pr-48 pb-16 text-lg border-b border-solid border-gray2">
            ...
            and, most importantly, how to contact your store with queries. Writing a detailed Customer Care policy is a
        ...
        <div className="px-40 pt-16 mx-10 bg-timberwolf text-gray2">
          ...
          <p className="pr-48 pb-4 text-lg">
            ...
            and protect their personal information. Add details such as how you use third-party banking to verify
            payment, the way you collect data or when will you contact users after their purchase was completed
            successfully.
          </p>
          <p className="pr-48 pb-16 text-lg border-b border-solid border-gray2">
            Your user’s privacy is of the highest importance to your business, so take the time to write an accurate and
            detailed policy. Use straightforward language to gain their trust and make sure they keep coming back to
            your site!
          </p>
        </div>
        <div className="px-40 pt-16 mx-10 bg-timberwolf text-gray2">
          ...
          <p className="pr-48 pb-16 text-lg border-b border-solid border-gray2">
            ...
            It’s easy. Just click “Edit Text” or double click me to add details about your policy and make changes to
            the font. I’m a great place for you to tell a story and let your users know a little more about you.
          </p>
        </div>
